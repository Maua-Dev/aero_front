...
export class IacStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const s3Bucket = new s3.Bucket(this, 'AeroFrontBucket' + stage, {
      versioned: true,
    ...
    const oac = new cloudfront.CfnOriginAccessControl(this, 'AOC', {
      originAccessControlConfig: {
        name: 'Aero Front Bucket OAC ' + stage,
    ...
    const cloudFrontWebDistribution = new cloudfront.CloudFrontWebDistribution(
      ...
      'CDN',
      {
        comment: 'Aero Front Distribution ' + stage,
        originConfigs: [
          {
            s3OriginSource: {
    ...
    new cdk.CfnOutput(this, 'AeroFrontBucketName-' + stage, {
      value: s3Bucket.bucketName
    })

    new cdk.CfnOutput(this, 'AeroFrontDistributionId-' + stage, {
      value: cloudFrontWebDistribution.distributionId
    })

    new cdk.CfnOutput(this, 'AeroFrontDistributionDomainName-' + stage, {
